...
module GSchool
  class CohortTest < Minitest::Test
    ...
    def test_cohort_from_yml
      ...
      assert_equal [:"Alice", :"Bob", :"Charlie", :"Dave", :"Eve"], cohort.students
      assert_equal [:"alice", :"bob", :"charlie", :"dave", :"eve"], cohort.usernames
      assert_equal [:"Alice", :"Charlie", :"Dave", :"Eve"], cohort.all

      assert_equal [:"Bob", :"Charlie", :"Eve"], cohort.teammates("Alice")
    end
  end
end
